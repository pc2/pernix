...
#pragma GCC unroll 512
     ...
     * @return int status code (0 for success).
     */
    int decompress_blocks(AvailableImplementations implementation, uint8_t bit_width, const uint8_t *input,
                          float_t scale, float_t *output,
                          uint32_t blocks);
     ...
     * @return int status code (0 for success).
     */
    int decompress_block(AvailableImplementations implementation, uint8_t bit_width, const uint8_t *input,
                         float_t scale, float_t *output);
} // namespace libcompression
