...
#define PERNIX_BUILD_X86_BMI2 1
    ...
    (defined(__AVX512F__) && defined(__AVX512DQ__) && defined(__AVX512BW__) && defined(__AVX512VL__) && defined(__AVX512VBMI__))
...
Kernel<KernelBlockF32Func> select_decompress_block_f32(Backend backend, u8 bit_width, u32 block_size, bool sign_values);

Kernel<KernelBlocksF32Func> select_decompress_blocks_f32(Backend backend, u8 bit_width, u32 block_size, bool sign_values);

Kernel<KernelBlockF64Func> select_decompress_block_f64(Backend backend, u8 bit_width, u32 block_size, bool sign_values);

Kernel<KernelBlocksF64Func> select_decompress_blocks_f64(Backend backend, u8 bit_width, u32 block_size, bool sign_values);
...
Kernel<KernelBlockF32Func> select_fallback_decompress_block_f32(u8 bit_width, u32 block_size, bool sign_values);

Kernel<KernelBlocksF32Func> select_fallback_decompress_blocks_f32(u8 bit_width, u32 block_size, bool sign_values);

Kernel<KernelBlockF64Func> select_fallback_decompress_block_f64(u8 bit_width, u32 block_size, bool sign_values);

Kernel<KernelBlocksF64Func> select_fallback_decompress_blocks_f64(u8 bit_width, u32 block_size, bool sign_values);
...
Kernel<KernelBlockF32Func> select_fallback_scalar_decompress_block_f32(u8 bit_width, u32 block_size, bool sign_values);

Kernel<KernelBlocksF32Func> select_fallback_scalar_decompress_blocks_f32(u8 bit_width, u32 block_size, bool sign_values);

Kernel<KernelBlockF64Func> select_fallback_scalar_decompress_block_f64(u8 bit_width, u32 block_size, bool sign_values);

Kernel<KernelBlocksF64Func> select_fallback_scalar_decompress_blocks_f64(u8 bit_width, u32 block_size, bool sign_values);
...
Kernel<KernelBlockF32Func> select_fallback_stdpar_decompress_block_f32(u8 bit_width, u32 block_size, bool sign_values);

Kernel<KernelBlocksF32Func> select_fallback_stdpar_decompress_blocks_f32(u8 bit_width, u32 block_size, bool sign_values);

Kernel<KernelBlockF64Func> select_fallback_stdpar_decompress_block_f64(u8 bit_width, u32 block_size, bool sign_values);

Kernel<KernelBlocksF64Func> select_fallback_stdpar_decompress_blocks_f64(u8 bit_width, u32 block_size, bool sign_values);
...
Kernel<KernelBlockF32Func> select_fallback_simd_decompress_block_f32(u8 bit_width, u32 block_size, bool sign_values);

Kernel<KernelBlocksF32Func> select_fallback_simd_decompress_blocks_f32(u8 bit_width, u32 block_size, bool sign_values);

Kernel<KernelBlockF64Func> select_fallback_simd_decompress_block_f64(u8 bit_width, u32 block_size, bool sign_values);

Kernel<KernelBlocksF64Func> select_fallback_simd_decompress_blocks_f64(u8 bit_width, u32 block_size, bool sign_values);
...
Kernel<KernelBlockF32Func> select_avx512vbmi_decompress_block_f32(u8 bit_width, u32 block_size, bool sign_values);

Kernel<KernelBlocksF32Func> select_avx512vbmi_decompress_blocks_f32(u8 bit_width, u32 block_size, bool sign_values);

Kernel<KernelBlockF64Func> select_avx512vbmi_decompress_block_f64(u8 bit_width, u32 block_size, bool sign_values);

Kernel<KernelBlocksF64Func> select_avx512vbmi_decompress_blocks_f64(u8 bit_width, u32 block_size, bool sign_values);
