...
Kernel<KernelBlockF32Func> select_avx512vbmi_compress_block_f32(const uint8_t bit_width, const uint32_t block_size) {
    switch (block_size) {
...
Kernel<KernelBlocksF32Func> select_avx512vbmi_compress_blocks_f32(const uint8_t bit_width, const uint32_t block_size) {
    switch (block_size) {
...
Kernel<KernelBlockF64Func> select_avx512vbmi_compress_block_f64(const uint8_t bit_width, const uint32_t block_size) {
    switch (block_size) {
...
Kernel<KernelBlocksF64Func> select_avx512vbmi_compress_blocks_f64(const uint8_t bit_width, const uint32_t block_size) {
    switch (block_size) {
